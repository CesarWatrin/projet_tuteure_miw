...
@section('content')
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-4">
            <a href="{{ route('home') }}" class="d-block text-center mb-4"><i class="la la-arrow-circle-left"></i> {{ trans('macyo_custom.back_to_site') }}</a>
            <h1 class="text-center mb-4">{{ trans('macyo_custom.admin_portal') }}</h1>
