    ...
    <div class="info_shop">
        ...
        <form method="post" action="{{route('store_post')}}" enctype="multipart/form-data">
            ...
            <div class="input-row">
                ...
                <input type="text" id="name" class="input-store" placeholder="Nom du commerce" name="name" onfocusout="verifyName(this.value)" value="{{isset($store) ? $store[0]->name: ""}}" autofocus required>
                @error('name')
            ...
            <div class="input-row">
                ...
                <textarea class="input-store" id="description" name="description"  onfocusout="verifyDesc(this.value)"  placeholder="Description du commerce">{{isset($store) ? $store[0]->description: ""}}</textarea>
                @error('description')
                <span class="input_error">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="input-row">
                ...
                <input type="email" id="email" class="input-store" placeholder="Adresse Email" name="email" onfocusout="verifyEmail(this.value)" value="{{isset($store) ? $store[0]->email: ""}}" required>
                @error('email')
                <span class="input_error">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="input-row">
                ...
                <input type="phone" id="phonenumber" class="input-store" placeholder="Numéro de Téléphone" name="phonenumber" onfocusout="verifyPhone(this.value)" value="{{isset($store) ? $store[0]->phonenumber: ""}}" required>
                @error('phonenumber')
                <span class="input_error">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="input-row">
                ...
                <input type="text" id="city_Id" class="input-store" placeholder="Ville" name="ville"  onfocusout="verifyVille(this.value)" value="{{isset($store) ? $store[0]->city: ""}}" required>
                @error('ville')
                <span class="input_error">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="input-row">
                ...
                <input type="text" id="address1" class="input-store" placeholder="Adresse" name="address1"  onfocusout="verifyAdresse1(this.value)" value="{{isset($store) ? $store[0]->address1: ""}}" required>
                @error('address1')
                <span class="input_error">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="input-row">
                ...
                <input type="text" id="address2" class="input-store" placeholder="Complement d'adresse"  onfocusout="verifyAdresse2(this.value)" value="{{isset($store) ? $store[0]->address2: ""}}" name="address2" >
                @error('address2')
                <span class="input_error">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="input-row">
                ...
                <textarea class="form-control" id="catalog"  name="catalog">{{isset($store) ? $store[0]->catalog: ""}}</textarea>
                @error('catalog')
                <span class="input_error">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="input-row">
                ...
                <textarea class="input-store" id="opening_hours" name="opening_hours"  onfocusout="verifyHoraires(this.value)"  placeholder="Horaires d'ouverture">{{isset($store) ? $store[0]->opening_hours: ""}}</textarea>
                @error('opening_hours')
                <span class="input_error">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="input-row">
                ...
                <input type="text" id="siret" class="input-store" placeholder="Numero de Siret" name="siret"  onfocusout="verifySiret(this.value)"  value="{{isset($store) ? $store[0]->siret: ""}}" required>
                @error('siret')
                <span class="input_error">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="input-row">
                ...
                <input type="text" id="website" class="input-store" placeholder="Url du site web" name="website"  onfocusout="verifyWeb(this.value)" value="{{isset($store) ? $store[0]->website: ""}}" required>
                @error('website')
                <span class="input_error">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="input-row">
                ...
                @if(isset($store) && $store[0]->delivery)
                    ...
                    <div class="livraison_button">
                        <input type="radio" name="delivery" class="livraison_radio" id="deliveryNon" value="0" checked/>
                ...
                @elseif(isset($store) && !$store[0]->delivery)
                    <div class="livraison_button">
                        <input type="radio" name="delivery" class="livraison_radio" id="deliveryOui" value="1" onclick="ischecked(this)" checked/>
                        <label for="deliveryOui" class="livraison_label">
                            <span class="livraison_titre">Oui</span>
                        </label>
                    </div>
            ...
            <div class="input-row">
                ...
                <input type="text" id="delivery_conditions" class="input-store" placeholder="Conditions de livraison" name="delivery_conditions" value="{{isset($store) ? $store[0]->delivery_conditions: ""}}">
            </div>
