...
class WeeklyUsersChartController extends ChartController
{
    public function setup()
    {
        ...
        for ($weeks_backwards = 4; $weeks_backwards >= 0; $weeks_backwards--) {
            ...
            $users[] = DB::table('users')->whereBetween('created_at', [today()->weekday(0)->subWeeks($weeks_backwards), today()->weekday(6)->subWeeks($weeks_backwards)])->count();
        }

        $this->chart->dataset('nouveaux utilisateurs', 'line', $users)
